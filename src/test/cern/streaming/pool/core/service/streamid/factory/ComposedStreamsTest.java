...
public class ComposedStreamsTest extends AbstractStreamTest implements RxStreamSupport {
    ...
    public void testEqualityOfMappedStreamIdOnEqualStreams() {
        StreamId<Object> sourceStreamId = new StreamId<Object>() {};
    ...
    public void testEqualityOfMappedStreamIdOnNotEqualStreamSources() {
        Function<Object, Optional<Object>> conversion = Optional::of;
        StreamId<Object> mappedStream1 = ComposedStreams.mappedStream(new StreamId<Object>() {}, conversion);
        StreamId<Object> mappedStream2 = ComposedStreams.mappedStream(new StreamId<Object>() {}, conversion);
        assertThat(mappedStream1).isNotEqualTo(mappedStream2);
    }
    ...
    public void testEqualityOfFlatMappedStreamIdOnNotEqualStreamSources() {
        Function<Object, ReactiveStream<Object>> conversion = o -> ReactiveStreams.fromRx(Observable.empty());
        StreamId<Object> flatMappedStream1 = ComposedStreams.flatMappedStream(new StreamId<Object>() {}, conversion);
        StreamId<Object> flatMappedStream2 = ComposedStreams.flatMappedStream(new StreamId<Object>() {}, conversion);
    ...
    public void testEqualityOfFlatMappedStreamIdOnNotEqualConversions() {
        StreamId<Object> sourceStreamId = new StreamId<Object>() {};
        StreamId<Object> flatMappedStream1 = ComposedStreams.flatMappedStream(sourceStreamId, o -> ReactiveStreams.fromRx(Observable.empty()));
        StreamId<Object> flatMappedStream2 = ComposedStreams.flatMappedStream(sourceStreamId, o -> ReactiveStreams.fromRx(Observable.empty()));
        assertThat(flatMappedStream1).isNotEqualTo(flatMappedStream2);
    }
    ...
    public void testEqualityOfMergedStreamIdOnEqualStreams() {
        StreamId<Object> sourceStreamId1 = new StreamId<Object>() {};
        StreamId<Object> sourceStreamId2 = new StreamId<Object>() {};
    ...
    public void testEqualityOfMergedStreamIdOnNotEqualStreamSources() {
        StreamId<Object> sourceStreamId1 = new StreamId<Object>() {};
        StreamId<Object> sourceStreamId2 = new StreamId<Object>() {};
        StreamId<Object> sourceStreamId3 = new StreamId<Object>() {};
        StreamId<Object> mergedStream1 = ComposedStreams.mergedStream(Arrays.asList(sourceStreamId1, sourceStreamId2));
        StreamId<Object> mergedStream2 = ComposedStreams.mergedStream(Arrays.asList(sourceStreamId1, sourceStreamId3));
    ...
    public void testEqualityOfFilteredStreamIdOnNotEqualStreamSources() {
        Predicate<Object> predicate = o -> true;
        StreamId<Object> filteredStream1 = ComposedStreams.filteredStream(new StreamId<Object>() {}, predicate);
        StreamId<Object> filteredStream2 = ComposedStreams.filteredStream(new StreamId<Object>() {}, predicate);
    ...
    public void testEqualityOfDelayedStreamIdOnNotEqualStreamSources() {
        StreamId<Object> delayedStream1 = ComposedStreams.delayedStream(new StreamId<Object>() {}, Duration.ZERO);
        StreamId<Object> delayedStream2 = ComposedStreams.delayedStream(new StreamId<Object>() {}, Duration.ZERO);
    ...
    public void testEqualityOfZippedStreamIdOnNotEqualStreamSources() {
        BiFunction<Object, Object, Optional<Object>> conversion = (o1, o2) -> Optional.empty();
        StreamId<Object> zippedStream1 = ComposedStreams.zippedStream(new StreamId<Object>() {},
                new StreamId<Object>() {}, conversion);
        StreamId<Object> zippedStream2 = ComposedStreams.zippedStream(new StreamId<Object>() {},
                new StreamId<Object>() {}, conversion);
    ...
    public void testEqualityOfZippedStreamIdOnNotEqualConverions() {
        StreamId<Object> sourceStreamId1 = new StreamId<Object>() {};
        StreamId<Object> sourceStreamId2 = new StreamId<Object>() {};
        StreamId<Object> zippedStream1 = ComposedStreams.zippedStream(sourceStreamId1, sourceStreamId2, (o1, o2) -> Optional.empty());
        StreamId<Object> zippedStream2 = ComposedStreams.zippedStream(sourceStreamId1, sourceStreamId2, (o1, o2) -> Optional.empty());
        assertThat(zippedStream1).isNotEqualTo(zippedStream2);
    }
